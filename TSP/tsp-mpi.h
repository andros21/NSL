...
public:
    ...
    Tour() : _tour(), _fitness(0.), _distance(0.){ };
...
public:
    ...
    GeneticAlgo(double mutationRate, double crossoverRate, string seedin) : _mutationRate(mutationRate), _crossoverRate(
            crossoverRate)
    { _rnd.SetRandom(seedin); }
